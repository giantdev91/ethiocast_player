...
export default class Menu extends Component {
    ...
    //                         <FontAwesome style={styles.IconsMenu} icon={SolidIcons.user} />
    //                     </View>
    ...
    //                     <View style={{ flex: 1 }}>
    //                         <View style={styles.CenterImage}>
    //                             <FontAwesome style={styles.IconsMenu} icon={SolidIcons.search} />
    //                         </View>
    ...
    //                             )}
    //                             <FontAwesome style={styles.IconsMenu} icon={RegularIcons.envelope} />
    //                         </View>
    ...
    //                             )}
    //                             <FontAwesome style={styles.IconsMenu} icon={SolidIcons.slidersHh} />
    //                         </View>
    ...
    //                 <View style={{ flex: 1, }}>
    //                     <View style={styles.CenterImage}>
    //                         <FontAwesome style={styles.IconsMenu} icon={SolidIcons.history} />
    //                     </View>
    ...
    //                         <FontAwesome style={styles.IconsMenu} icon={RegularIcons.playCircle} />
    ...
    //                 <View style={{ flex: 1, justifyContent: 'flex-start', alignContent: 'flex-start', alignItems: 'flex-start', margin: 10 }}>
    //                     <View style={[{ flexDirection: 'row', justifyContent: 'center', alignContent: 'center', alignItems: 'center' }]}>
    //                         <FontAwesome style={styles.IconsMenu} icon={RegularIcons.heart} />
    ...
    //                 <View style={{ flex: 1, justifyContent: 'flex-start', alignContent: 'flex-start', alignItems: 'flex-start', margin: 10 }}>
    //                     <View style={[{ flexDirection: 'row', justifyContent: 'center', alignContent: 'center', alignItems: 'center' }]}>
    //                         <FontAwesome style={styles.IconsMenu} icon={SolidIcons.download} />
