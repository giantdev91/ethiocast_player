                        ...
                        >
                            ...
                            >
                                ...
                                <View style={{alignItems: 'center'}}>
                                    {/* <FontAwesome style={[styles.IconsMenuMedium, { color: '#666', paddingVertical: 5 }]} icon={SolidIcons.chevronUp} /> */}
                                </View>
                                ...
                                />
                                <View style={{alignItems: 'center'}}>
                                    {/* <FontAwesome style={[styles.IconsMenuMedium, { color: '#666', paddingVertical: 5 }]} icon={SolidIcons.chevronDown} /> */}
                                </View>
                            </View>
                            <View
                                style={{
